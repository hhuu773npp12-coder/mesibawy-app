...
class CraftSelectScreen extends StatelessWidget {
  const CraftSelectScreen({super.key});
  ...
  Widget build(BuildContext context) {
    final items = <_Item>[
      _Item('كهربائي', Icons.electrical_services, 'electrician'),
      _Item('سباك', Icons.plumbing, 'plumber'),
      _Item('حداد', Icons.home_repair_service, 'blacksmith'),
      _Item('فني تبريد', Icons.ac_unit, 'ac_tech'),
    ];
    return Scaffold(
      appBar: AppBar(title: const Text('فرز أصحاب الحرف')),
