...
class VehicleSelectScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = <_Item>[
      _Item('صاحب تكسي', Icons.local_taxi, 'taxi'),
      _Item('صاحب تكتك', Icons.electric_scooter, 'tuk_tuk'),
      _Item('صاحب كيا حمل', Icons.local_shipping, 'kia_haml'),
      _Item('صاحب كيا نقل الركاب', Icons.directions_bus, 'kia_passenger'),
      _Item('صاحب ستوتة', Icons.agriculture, 'stuta'),
      _Item('صاحب دراجة', Icons.pedal_bike, 'bike'),
    ];
    return Scaffold(
      appBar: AppBar(title: const Text('فرز أصحاب المركبات')),
